...
public:
    ...
    void inserir(std::string chave, Title *p, int *op);
    void inserirAux(BSTNode *no, std::string chave, Title *p, int *op); 
    ...
    void auxLimpar();
    BSTNode* pesquisar(std::string valor, BSTNode *no, int *op);
