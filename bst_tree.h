...
public:
    ...
    void findMaxAnaliseFilme(std::string procurar, float *maximo, BSTNode *no,int choice, BSTNode *noMaximo);
    void findMinAnaliseFilme(std::string procurar, float *minimo, BSTNode *no,int choice, BSTNode *noMinimo);
